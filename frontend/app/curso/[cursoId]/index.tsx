...
export default function CursoScreen() {
  ...
  if (loading) return <CustomScreenView style={styles.bg}><Text>Cargando...</Text></CustomScreenView>;
  if (!course) return <CustomScreenView style={styles.bg}><Text>No se encontró el curso</Text></CustomScreenView>;
    ...
    <CustomScreenView style={styles.bg}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40, flexGrow: 1 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 18 }}>
          <Image source={{ uri: course.imagen ?? 'https://picsum.photos/id/374/462' }} style={styles.courseImage} />
        </View>
        {/* Tabs */}
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoCol}>
            <View style={styles.infoItem}>
              <View style={styles.infoIcon}><Image source={{ uri: 'https://picsum.photos/id/20/20' }} style={{ width: 20, height: 20 }} /></View>
              <Text style={styles.infoText}>6 semanas</Text>
            </View>
            <View style={styles.infoItem}>
              <View style={styles.infoIcon}><Image source={{ uri: 'https://picsum.photos/id/16/16' }} style={{ width: 16, height: 16 }} /></View>
          ...
          <View style={styles.infoCol}>
            <View style={styles.infoItem}>
              <View style={styles.infoIcon}><Image source={{ uri: 'https://picsum.photos/id/18/18' }} style={{ width: 18, height: 18 }} /></View>
              <Text style={styles.infoText}>intermedio</Text>
            </View>
            <View style={styles.infoItem}>
              <Image source={{ uri: 'https://picsum.photos/id/34/34' }} style={{ width: 34, height: 34, borderRadius: 8 }} />
              <Text style={styles.infoText}>4.8</Text>
            </View>
          </View>
        </View>
        {/* Descripción */}
        <Text style={styles.description}>{course.descripcion || 'Aprende desde cero las técnicas esenciales de la panadería artesanal. Descubre cómo hacer panes crujientes, esponjosos y llenos de sabor utilizando ingredientes naturales y procesos tradicionales.'}</Text>
        {/* White bar */}
        <View style={styles.topBar} />
        {/* Contenido */}
        <View style={styles.tabsRow}>
        ...
        <Text style={styles.contentDescription}>Clases en vivo por videoconferencia, interactúa con el instructor en tiempo real y accede a material digital.</Text>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 18 }}>
          {ingredientes.map((ing, idx) => (
            <View key={idx} style={styles.ingredientCard}>
              <Image source={{ uri: 'https://picsum.photos/113/93' }} style={styles.ingredientImg} />
      ...
      <TouchableOpacity style={styles.enrollBtn} onPress={() => router.push(`/curso/${cursoId}/inscripcion`)}>
