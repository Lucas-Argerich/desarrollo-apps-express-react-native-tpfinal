...
export default function NuevaRecetaScreen() {
  ...
  const handleCerrar = () => {
    ...
    setFotoPrincipal(undefined)
    setPorciones('')
    setTiempo('')
    setCategoria('')
    setDificultad('')
    setIngredientes([{ nombre: '', cantidad: '', unidad: '' }])
    setUtensilios([{ nombre: '', proveido: false }])
    setPasos([{ texto: '', nroPaso: 1 }])
    router.back()
  }
  ...
  return (
    <CustomScreenView style={{ paddingHorizontal: 16 }}>
      ...
      <View style={styles.headerBlock}>
        ...
        <Text style={styles.subtitle}>Crea una nueva receta paso a paso</Text>
      </View>
