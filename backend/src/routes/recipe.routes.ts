...
import { getRecipes, getRecipe, createRecipe, updateRecipe, deleteRecipe, addReview, addToFavorites, removeFromFavorites, getFavorites, checkFavorite, getCreatedRecipes } from '../controllers/recipe.controller';
...
router.delete('/:id', auth, requireRole(['profesor']), deleteRecipe);
